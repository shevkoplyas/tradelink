...
namespace ServerRedi
{
    public class ServerRedi 
    {
        ...
        public ServerRedi(TLServer tls, int sleepvalue)
        {
            ...
            tl.newPosList += new PositionAccountArrayDelegate(ServerRedi_gotSrvPosList);
        ...
        /// <summary>
        /// whether exchange smart orders are used for ICE and EUREXUS
        /// </summary>
        public bool AutoConvertToSmart = true;

        string getpricetype(Order o)
        {
            string type = "Invalid";
            if (AutoConvertToSmart && o.isStop && o.Exchange.Substring(0, 3).Equals("ICE"))
                type = "Smart Stop";
            else if (AutoConvertToSmart && o.isStop && o.isLimit && o.Exchange.Substring(0, 7).Equals("EUREXUS"))
                type = "Smart Stop Lmt";
            else if (o.isStop && o.isLimit)
                type = "Stop Limit";
            else if (o.isStop)
                type = "Stop";
            else if (o.isLimit)
        ...
        public bool isAddingFuturesEXSpace = true;
        public List<string> FuturesEXchanges = new List<string>(new string[] { "CME", "CBOT", "NYMEX" });
            ...
            while (_bwgo)
            {
                ...
                {                  
                    ...
                    else
                    {
                        ...
                        // see issue 1998 https://code.google.com/p/tradelink/issues/detail?id=1988
                        if (isAddingFuturesEXSpace && FuturesEXchanges.Contains(o.ex))
                            o.ex += " ";
        ...
        public bool Start(string user,string pw, string accnt)
        {
            ...
            debug("Papertrading: "+(isPaperTradeEnabled ? "ON." : "disabled."));
