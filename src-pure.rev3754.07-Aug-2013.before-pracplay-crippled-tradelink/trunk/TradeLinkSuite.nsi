...
Section "TradeLinkSuite"
  ...
  CreateShortCut "$SMPROGRAMS\TradeLink\Warden.lnk" "$INSTDIR\Warden.EXE" "" "$INSTDIR\Warden.EXE" 0  
  ...
  File "ServerSterling\dll\Interop.SterlingLib.dll"
  ...
  File "ServerRedi\bin\x86\release\ServerRedi.exe"
  File "ServerRedi\bin\x86\release\Interop.RediLib.dll"
  File "ServerRedi\bin\x86\release\VBRediClasses.dll"
  ...
  File "Warden\bin\release\Warden.exe"
  File "Warden\bin\release\Affirma.ThreeSharp.dll"
  ...
  File /nonfatal "Install\Install-Glean.exe"
	...
	File /nonfatal "ServerMB\bin\x86\release\ServerMB.exe"
  ...
  File /nonfatal "ServerTDX\bin\x86\release\NZipLib.dll"
  File /nonfatal "ServerTDX\bin\x86\release\TDServerX.exe"
  File /nonfatal "ServerTDX\bin\x86\release\AxInterop.tdaactx.dll"
  File /nonfatal "ServerTDX\bin\x86\release\Interop.tdaactx.dll"
  File /nonfatal "ServerTDX\bin\x86\release\Interop.MSXML2.dll"
  File /nonfatal "ServerTDX\bin\x86\release\Interop.MSXML2.dll"
  ...
  File "ServerRedi\bin\x86\release\ServerRedi.exe.config"
  ...
  File "Warden\bin\release\Warden.exe.config"
...
Section "VC Redistributable"
  ...
  ; vcredist http://blogs.msdn.com/b/astebner/archive/2007/02/07/update-regarding-silent-install-of-the-vc-8-0-runtime-vcredist-packages.aspx
...
Section "Start Glean"
 Exec "$PROGRAMFILES\Glean\Glean.exe"
SectionEnd
...
Function .onInit
  ...
  Call IsSilent
   ...
   ;SetRegView 64
   ; change install dir 
   StrCpy $INSTDIR "$PROGRAMFILES64\TradeLink"
${EndIf}
